...
Notes and hands-on practice for Kubernetes. The `krm/` track builds platform APIs (CRD/CR/Controller, Crossplane, kro) without writing a Go controller for the common case; `ckad/` holds finished CKAD study notes.
